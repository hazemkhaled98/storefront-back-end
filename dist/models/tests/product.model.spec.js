...
describe('Product Model functionality', function () {
    //test create
    it('create method should add and return a product', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
    ...
    // test delete
    it('delete method should remove and return the product', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result, products;
        return __generator(this, function (_a) {
            switch (_a.label) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    alterID = 'ALTER SEQUENCE products_id_seq RESTART WITH 1';
