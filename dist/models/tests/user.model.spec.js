...
describe('user Model functionality', function () {
    //test create
    it('create method should add and return a user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, user.update({
                        ...
                        first_name: 'Eren',
                        last_name: 'Yeager',
                        password: (0, user_model_1.hash)('141414')
                    })];
                case 1:
                    result = _a.sent();
                    expect(result).toEqual({
    ...
    // test delete
    it('delete method should remove and return the user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result, users;
        return __generator(this, function (_a) {
            switch (_a.label) {
